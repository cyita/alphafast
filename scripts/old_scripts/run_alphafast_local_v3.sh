...
#   - Updated default paths for new node.
#
# Usage:
#   ./scripts/run_alphafast_local_v3.sh \
...
echo "=========================================="
echo "AlphaFast Run (No Container) v3"
echo "=========================================="
